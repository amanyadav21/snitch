      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white mb-6">OFFLINE STORE</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white mb-6">GET TO KNOW US</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">
                  FAQ's
          ...
          {/* Orders Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white mb-6">ORDERS</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">
                  TRACK ORDER
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white mb-6">SIGN UP AND SAVE</h3>
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-4">
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500"
                  required
                />
                <button
                  type="submit"
                  className="px-6 py-3 bg-green-600 text-white font-semibold hover:bg-green-700 transition-colors duration-200"
                >
                  SUBSCRIBE
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <p className="text-gray-300 text-sm">© 2025 SNITCH</p>
              <span className="text-gray-300 text-sm">Made in India, for the World 🌍</span>
            </div>
