            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
                <input
                  ...
                  className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-white text-black placeholder-gray-500 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-green-500 rounded sm:rounded-none sm:rounded-l"
                  required
                />
                <button
                  type="submit"
                  className="px-4 sm:px-6 py-2.5 sm:py-3 bg-green-600 text-white font-semibold text-sm sm:text-base hover:bg-green-700 transition-colors duration-200 rounded sm:rounded-none sm:rounded-r"
                >
                  SUBSCRIBE
                </button>
              </div>
